...
public class ListaHorariosTarde extends javax.swing.JFrame {

    GestorBD g = new GestorBD();

    public ListaHorariosTarde() {
        initComponents();
    }
...
//        tblHorarios.getColumnModel().getColumn(2).setCellRenderer(centerRenderer);
    ...
    public void actualizarPanel(int idSalaH) {
        ...
        for (SalasHorarios x : listadoHorarioSala) {
            ...
            switch (x.getIdHorario()) {
                case 4: { //horario  15- 15:40     ------- entra por acá
    ...
    private void initComponents() {
        ...
        lblDirectivos.setText("HORARIOS SALAS TURNO TARDE");
        ...
        jLabel2.setText("15:00 a 15:40 hs");
        ...
        jLabel4.setText("16:00 a 16:40 hs");
        ...
        jLabel3.setText("17:00 a 17:40 hs");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaHorariosTarde.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListaHorariosTarde().setVisible(true);
            }
        });
    }
